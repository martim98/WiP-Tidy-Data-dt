...
wip <- fread(here("data", "WB-WiP.csv"), 
             skip = 4, header = TRUE,
             check.names = TRUE, encoding = 'UTF-8') #encoding
...
WP[Country %in% dclpct] %>%
  ...
  ggtitle('Women in Parliament: Decline in 5%') + 
  ylab('% Women in Parliament')

```

## Global Rankings by Year

```{r globalRanking, echo= FALSE}
...
## Highest rak by year and continent

```{r yearContinent, echo = FALSE}
